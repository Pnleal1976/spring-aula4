package next.scholl.cesar.springaula4.controllers;
...
import next.scholl.cesar.springaula4.entities.Person;
...
public ResponseEntity<Person> update(
            @RequestBody Person p,             @PathVariable(value = "id") int id) {
